...
export default function ContactList() {
    ...
    return (
        <div className='w-full h-full flex flex-col gap-2 justify-start items-center border border-yellow-400 select-none'>
                <div className="px-4 py-2 w-full flex justify-between items-center gap-4 bg-base-200" >
                    <span 
                ...
                <div className="w-full flex flex-col gap-4 pl-4" style={{visibility:collapsed?'hidden':'visible'}}> 
                    {
